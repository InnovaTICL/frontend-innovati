...
function Contacto() {
    ...
    try {
      ...
      if (res.ok && data?.ok) {
        ...
        const niceMsg =
          data?.msg ||
          data?.detail?.message ||
          (Array.isArray(data?.detail?.errors?.to) &&
            data.detail.errors.to[0]) ||
          data?.error ||
  ...
  return (
    <>
      {/* HERO */}
      <section className="hero text-white py-5" data-aos="fade-down">
        <Container>
          <Row className="align-items-center text-center">
            <Col md={{ span: 10, offset: 1 }}>
              ...
              <p className="lead opacity-90">
                Conversemos sobre tu proyecto: te respondemos en menos de 24
                horas hábiles.
              </p>
            </Col>
          </Row>
        ...
        <Container>
          <Row className="g-4 align-items-stretch">
            <Col lg={7} data-aos="fade-right">
              <Card className="border-0 shadow-soft rounded-3 h-100">
                <Card.Body>
                  ...
                  <Form onSubmit={onSubmit} noValidate>
                    ...
                    <div className="d-flex flex-wrap gap-3 mt-4">
                      <Button
                        type="submit"
                        className="btn-gradient px-4 fw-semibold"
                        disabled={enviando}
                      >
                      ...
                      <Button
                        ...
                        className="btn-whatsapp d-inline-flex align-items-center gap-2 fw-semibold"
                      >
                        <FaWhatsapp size={18} />
              ...
              <Card className="border-0 shadow-soft rounded-3 h-100">
                <Card.Body>
                  ...
                  <ListGroup variant="flush" className="mt-3">
                    <ListGroup.Item className="border-0 ps-0 pb-3">
                      <div className="d-flex flex-column">
                        <span className="text-muted small mb-1">Correo</span>
                        <a
      ...
      {/* CTA final */}
      <section
        className="py-5 text-center bg-white border-top"
        data-aos="fade-up"
      >
        <Container>
          <h2 className="mb-2 fw-bold">¿Prefieres agendar una llamada?</h2>
          <p className="text-muted mb-4">
            Coordinamos una videollamada de 20 minutos y te mostramos opciones.
          </p>
